...
@php
    ...
    function getProducts($order_id){
        $products = DB::table("order_details")->join("products","products.id","=","order_details.product_id")->select("products.name","products.photo","products.discount","order_details.quantity","order_details.price")->where("order_details.order_id", "=", $order_id)->get();
        return $products;
    }
@endphp
